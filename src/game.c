...
void gaame_over(bool *running, SDL_Renderer *renderer, bool *encoredesennemis){//fin de partie
...
void cleanup(SDL_Window *window, SDL_Renderer *renderer, grille grilledennemis){//liberation de memoire
    if (renderer)
